...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Plan.ipv4_space'
        db.alter_column(u'offers_plan', 'ipv4_space', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Plan.bandwidth'
        db.alter_column(u'offers_plan', 'bandwidth', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Plan.cpu_cores'
        db.alter_column(u'offers_plan', 'cpu_cores', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Plan.memory'
        db.alter_column(u'offers_plan', 'memory', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Plan.disk_space'
        db.alter_column(u'offers_plan', 'disk_space', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Plan.ipv6_space'
        db.alter_column(u'offers_plan', 'ipv6_space', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Plan.ipv4_space'
        db.alter_column(u'offers_plan', 'ipv4_space', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Plan.bandwidth'
        db.alter_column(u'offers_plan', 'bandwidth', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Plan.cpu_cores'
        db.alter_column(u'offers_plan', 'cpu_cores', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Plan.memory'
        db.alter_column(u'offers_plan', 'memory', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Plan.disk_space'
        db.alter_column(u'offers_plan', 'disk_space', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Plan.ipv6_space'
        db.alter_column(u'offers_plan', 'ipv6_space', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'offers.plan': {
            ...
            'bandwidth': ('django.db.models.fields.PositiveIntegerField', [], {}),
            ...
            'cpu_cores': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'disk_space': ('django.db.models.fields.PositiveIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ipv4_space': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'ipv6_space': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
