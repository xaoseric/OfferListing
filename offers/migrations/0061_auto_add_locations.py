...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field locations on 'Plan'
        m2m_table_name = db.shorten_name(u'offers_plan_locations')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('plan', models.ForeignKey(orm[u'offers.plan'], null=False)),
            ('location', models.ForeignKey(orm[u'offers.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['plan_id', 'location_id'])


    def backwards(self, orm):
        # Removing M2M table for field locations on 'Plan'
        db.delete_table(db.shorten_name(u'offers_plan_locations'))
