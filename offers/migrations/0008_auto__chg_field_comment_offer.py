...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.offer'
        db.alter_column(u'offers_comment', 'offer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.Offer']))

    def backwards(self, orm):

        # Changing field 'Comment.offer'
        db.alter_column(u'offers_comment', 'offer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.Plan']))
