...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlanUpdate.plan'
        db.add_column(u'offers_planupdate', 'plan',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['offers.Plan'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlanUpdate.plan'
        db.delete_column(u'offers_planupdate', 'plan_id')
