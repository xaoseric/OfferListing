...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'offers_plan', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=timezone.now(), blank=True),
                      keep_default=False)

        # Adding field 'Plan.updated_at'
        db.add_column(u'offers_plan', 'updated_at',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'offers_plan', 'created_at')

        # Deleting field 'Plan.updated_at'
        db.delete_column(u'offers_plan', 'updated_at')
    ...
    models = {
        ...
        u'offers.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['offers.Plan']"}),
