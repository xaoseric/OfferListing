...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding model 'OfferRequest'
        db.create_table(u'offers_offerrequest', (
            ('offer', self.gf('django.db.models.fields.related.OneToOneField')(related_name='request', unique=True, to=orm['offers.Offer'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'offers', ['OfferRequest'])
