...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Provider.name_slug'
        db.alter_column(u'offers_provider', 'name_slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=255))
        # Adding unique constraint on 'Provider', fields ['name_slug']
        db.create_unique(u'offers_provider', ['name_slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Provider', fields ['name_slug']
        db.delete_unique(u'offers_provider', ['name_slug'])


        # Changing field 'Provider.name_slug'
        db.alter_column(u'offers_provider', 'name_slug', self.gf('django.db.models.fields.SlugField')(max_length=255, null=True))
