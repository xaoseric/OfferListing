...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OfferRequest.provider'
        db.delete_column(u'offers_offerrequest', 'provider_id')


    def backwards(self, orm):
        # Adding field 'OfferRequest.provider'
        db.add_column(u'offers_offerrequest', 'provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['offers.Provider']),
                      keep_default=False)
