...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.looking_glass'
        db.add_column(u'offers_location', 'looking_glass',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.looking_glass'
        db.delete_column(u'offers_location', 'looking_glass')
