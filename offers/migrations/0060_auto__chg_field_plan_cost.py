...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Plan.cost'
        db.alter_column(u'offers_plan', 'cost', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Plan.cost'
        db.alter_column(u'offers_plan', 'cost', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))
