...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Provider.aup'
        db.add_column(u'offers_provider', 'aup',
                      self.gf('django.db.models.fields.URLField')(default='http://example.com/aup', max_length=255),
                      keep_default=False)

        # Adding field 'Provider.sla'
        db.add_column(u'offers_provider', 'sla',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Provider.billing_agreement'
        db.add_column(u'offers_provider', 'billing_agreement',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Provider.aup'
        db.delete_column(u'offers_provider', 'aup')

        # Deleting field 'Provider.sla'
        db.delete_column(u'offers_provider', 'sla')

        # Deleting field 'Provider.billing_agreement'
        db.delete_column(u'offers_provider', 'billing_agreement')
