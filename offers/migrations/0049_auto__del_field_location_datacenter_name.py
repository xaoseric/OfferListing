...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Location.datacenter_name'
        db.delete_column(u'offers_location', 'datacenter_name')


    def backwards(self, orm):
        # Adding field 'Location.datacenter_name'
        db.add_column(u'offers_location', 'datacenter_name',
