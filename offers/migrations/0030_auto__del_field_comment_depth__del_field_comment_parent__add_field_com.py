...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Comment.depth'
        db.delete_column(u'offers_comment', 'depth')

        # Deleting field 'Comment.parent'
        db.delete_column(u'offers_comment', 'parent_id')

        # Adding field 'Comment.reply_to'
        db.add_column(u'offers_comment', 'reply_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.Comment'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Comment.depth'
        raise RuntimeError("Cannot reverse this migration. 'Comment.depth' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Comment.depth'
        db.add_column(u'offers_comment', 'depth',
                      self.gf('django.db.models.fields.IntegerField')(max_length=1),
                      keep_default=False)

        # Adding field 'Comment.parent'
        db.add_column(u'offers_comment', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.Comment'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Comment.reply_to'
        db.delete_column(u'offers_comment', 'reply_to_id')
