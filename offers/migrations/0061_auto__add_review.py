...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Review'
        db.create_table(u'offers_review', (
            ...
            ('rating_overall', self.gf('django.db.models.fields.PositiveIntegerField')(default=10, max_length=2)),
            ('rating_support', self.gf('django.db.models.fields.PositiveIntegerField')(default=10, max_length=2)),
            ('rating_value', self.gf('django.db.models.fields.PositiveIntegerField')(default=10, max_length=2)),
            ('rating_uptime', self.gf('django.db.models.fields.PositiveIntegerField')(default=10, max_length=2)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'offers', ['Review'])


    def backwards(self, orm):
        # Deleting model 'Review'
        db.delete_table(u'offers_review')
    ...
    models = {
        ...
        u'offers.review': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['offers.Provider']"}),
            'rating_overall': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10', 'max_length': '2'}),
            'rating_support': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10', 'max_length': '2'}),
            'rating_uptime': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10', 'max_length': '2'}),
            'rating_value': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10', 'max_length': '2'}),
