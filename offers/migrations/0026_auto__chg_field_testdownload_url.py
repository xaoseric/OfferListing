...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestDownload.url'
        db.alter_column(u'offers_testdownload', 'url', self.gf('django.db.models.fields.URLField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'TestDownload.url'
        db.alter_column(u'offers_testdownload', 'url', self.gf('django.db.models.fields.CharField')(max_length=255))
