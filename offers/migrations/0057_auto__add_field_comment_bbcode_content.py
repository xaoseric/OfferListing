...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.bbcode_content'
        db.add_column(u'offers_comment', 'bbcode_content',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.bbcode_content'
        db.delete_column(u'offers_comment', 'bbcode_content')
