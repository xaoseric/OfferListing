...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Review', fields ['author', 'provider']
        db.create_unique(u'offers_review', ['author_id', 'provider_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Review', fields ['author', 'provider']
        db.delete_unique(u'offers_review', ['author_id', 'provider_id'])
    ...
    models = {
        ...
        u'offers.review': {
            'Meta': {'ordering': "['-created_at']", 'unique_together': "(('author', 'provider'),)", 'object_name': 'Review'},
