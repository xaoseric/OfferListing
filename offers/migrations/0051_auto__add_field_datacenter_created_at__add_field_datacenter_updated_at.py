...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Datacenter.created_at'
        db.add_column(u'offers_datacenter', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=timezone.now, blank=True),
                      keep_default=False)

        # Adding field 'Datacenter.updated_at'
        db.add_column(u'offers_datacenter', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=timezone.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Datacenter.created_at'
        db.delete_column(u'offers_datacenter', 'created_at')

        # Deleting field 'Datacenter.updated_at'
        db.delete_column(u'offers_datacenter', 'updated_at')
