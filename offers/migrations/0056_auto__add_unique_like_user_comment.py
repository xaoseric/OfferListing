...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Like', fields ['user', 'comment']
        db.create_unique(u'offers_like', ['user_id', 'comment_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Like', fields ['user', 'comment']
        db.delete_unique(u'offers_like', ['user_id', 'comment_id'])
