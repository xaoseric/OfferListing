...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Provider.logo'
        db.alter_column(u'offers_provider', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Provider.logo'
        db.alter_column(u'offers_provider', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
