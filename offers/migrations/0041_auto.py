...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field favourite_users on 'Offer'
        db.delete_table(db.shorten_name(u'offers_offer_favourite_users'))

        # Adding M2M table for field following on 'Offer'
        m2m_table_name = db.shorten_name(u'offers_offer_following')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('offer', models.ForeignKey(orm[u'offers.offer'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['offer_id', 'user_id'])


    def backwards(self, orm):
        # Adding M2M table for field favourite_users on 'Offer'
        m2m_table_name = db.shorten_name(u'offers_offer_favourite_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('offer', models.ForeignKey(orm[u'offers.offer'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ...
        # Removing M2M table for field following on 'Offer'
        db.delete_table(db.shorten_name(u'offers_offer_following'))
    ...
    models = {
        ...
        u'offers.offer': {
            ...
            'following': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'followed_offers'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
