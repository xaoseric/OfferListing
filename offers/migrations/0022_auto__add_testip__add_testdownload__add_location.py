...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TestIP'
        db.create_table(u'offers_testip', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='test_ips', to=orm['offers.Location'])),
            ('ip_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('ip', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'offers', ['TestIP'])

        # Adding model 'TestDownload'
        db.create_table(u'offers_testdownload', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='test_downloads', to=orm['offers.Location'])),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('size', self.gf('django.db.models.fields.BigIntegerField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'offers', ['TestDownload'])

        # Adding model 'Location'
        db.create_table(u'offers_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.TextField')()),
            ('datacenter', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(related_name='locations', to=orm['offers.Provider'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'offers', ['Location'])


    def backwards(self, orm):
        # Deleting model 'TestIP'
        db.delete_table(u'offers_testip')

        # Deleting model 'TestDownload'
        db.delete_table(u'offers_testdownload')

        # Deleting model 'Location'
        db.delete_table(u'offers_location')
