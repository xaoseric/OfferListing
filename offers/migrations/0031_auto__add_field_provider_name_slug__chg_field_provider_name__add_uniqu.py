...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Provider.name_slug'
        db.add_column(u'offers_provider', 'name_slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=255, null=True),
                      keep_default=False)


        # Changing field 'Provider.name'
        db.alter_column(u'offers_provider', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250))
        # Adding unique constraint on 'Provider', fields ['name']
        db.create_unique(u'offers_provider', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Provider', fields ['name']
        db.delete_unique(u'offers_provider', ['name'])

        # Deleting field 'Provider.name_slug'
        db.delete_column(u'offers_provider', 'name_slug')


        # Changing field 'Provider.name'
        db.alter_column(u'offers_provider', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'offers.provider': {
            ...
            'name_slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'null': 'True'}),
