...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlanUpdate.plan'
        db.alter_column(u'offers_planupdate', 'plan_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['offers.Plan'], unique=True, null=True, on_delete=models.SET_NULL))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PlanUpdate.plan'
        db.alter_column(u'offers_planupdate', 'plan_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['offers.Plan'], unique=True, null=True))
    ...
    models = {
        ...
        u'offers.comment': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['offers.Comment']", 'null': 'True', 'blank': 'True'}),
