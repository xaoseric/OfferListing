...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.datacenter'
        db.add_column(u'offers_location', 'datacenter',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.Datacenter'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.datacenter'
        db.delete_column(u'offers_location', 'datacenter_id')
