...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfferUpdate.for_offer'
        db.add_column(u'offers_offerupdate', 'for_offer',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['offers.Offer'], unique=True),
                      keep_default=False)

        # Adding field 'OfferUpdate.user'
        db.add_column(u'offers_offerupdate', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfferUpdate.for_offer'
        db.delete_column(u'offers_offerupdate', 'for_offer_id')

        # Deleting field 'OfferUpdate.user'
        db.delete_column(u'offers_offerupdate', 'user_id')
