...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'offers_offerupdate', (
            ...
            ('for_offer', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['offers.Offer'], unique=True)),
        ))
        ...
        db.create_table(u'offers_planupdate', (
            ...
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.Location'])),
            ...
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('plan', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['offers.Plan'], unique=True, null=True, on_delete=models.SET_NULL, blank=True)),
        ))
