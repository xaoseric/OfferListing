...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.datacenter'
        db.alter_column(u'offers_location', 'datacenter_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['offers.Datacenter']))

    def backwards(self, orm):

        # Changing field 'Location.datacenter'
        db.alter_column(u'offers_location', 'datacenter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['offers.Datacenter'], null=True))
