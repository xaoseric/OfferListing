...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plan.location'
        db.add_column(u'offers_plan', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['offers.Location']),
                      keep_default=False)

        # Adding field 'PlanUpdate.location'
        db.add_column(u'offers_planupdate', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['offers.Location']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PlanUpdate.location'
        db.delete_column(u'offers_planupdate', 'location_id')
